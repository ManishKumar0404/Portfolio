    ...
    <div className="bg-black text-white min-h-screen font-sans scroll-smooth">
      ...
      <nav className="fixed top-0 left-0 w-full bg-black/60 backdrop-blur-md border-b border-gray-800 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <h1 className="text-2xl font-bold text-cyan-400">Manish.dev</h1>
      ...
      >
        <div className="absolute w-96 h-96 bg-cyan-500/20 rounded-full blur-3xl top-20 left-10"></div>
        <div className="absolute w-96 h-96 bg-purple-500/20 rounded-full blur-3xl bottom-20 right-10"></div>

        <div className="text-center z-10">
          <h2 className="text-5xl md:text-7xl font-extrabold leading-tight">
            Hi, I'm <span className="text-cyan-400">Manish Kumar</span>
          </h2>

          <p className="mt-6 text-gray-400 text-xl md:text-2xl max-w-2xl mx-auto">
            Full Stack Developer | Tech Enthusiast | React Developer
          </p>
      ...
      <section id="about" className="py-24 px-6 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center">
            <div className="w-72 h-72 rounded-3xl bg-gradient-to-br from-cyan-500 to-purple-500 p-1 shadow-2xl shadow-cyan-500/30">
              <div className="w-full h-full bg-black rounded-3xl overflow-hidden relative">
                ...
                {showAvatarFallback && (
                  <div className="w-full h-full flex items-center justify-center text-7xl font-bold text-cyan-400">
                    MK
                  </div>
                )}
              </div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg leading-8">
              ...
              applications, and futuristic UI designs. I enjoy working with
              React, JavaScript, and backend technologies to create fast and
      ...
      <footer className="border-t border-gray-800 py-8 text-center text-gray-500">
        <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-center gap-4">
          <p>© 2026 Manish Kumar. All rights reserved.</p>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="inline-block">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.852 0-2.135 1.445-2.135 2.94v5.666H9.351V9h3.414v1.561h.049c.476-.9 1.637-1.852 3.368-1.852 3.6 0 4.266 2.37 4.266 5.455v6.288zM5.337 7.433a2.064 2.064 0 1 1 0-4.129 2.064 2.064 0 0 1 0 4.129zM6.997 20.452H3.677V9h3.32v11.452z" />
              </svg>
            </a>
          </div>
        </div>
